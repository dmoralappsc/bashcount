The bashcount.sh is used to output to the Linux terminal a number count in sequential order based on the specified range. The count is written with the range 1-50. The range can be changed accordingly. 
